...
Let me start off by acknowledging that we are by *no means* the first people to ask [which](http://colorbrewer2.org/) [color](https://github.com/karthik/wesanderson) [palettes](https://github.com/dill/beyonce) are best for graphing. Further, I fully admit that we entered into this quickly and did not read the literature thoroughly nor think through *all* the possibilities that one should consider when embarking upon a proper research project. Which, to be fair, is why this is a blog post (and not a paper). 
...
<center><img src="/blog/images/ShanColors.png" width="500" height="500" /></center>

### Results

#### Color Palette Preference

![Preferences](/blog/images/PalettePreference.png)
...
<center><img src="/blog/images/bright.png" width="250" height="200" /></center>
...
<img src="/blog/images/Blues_mf.png", width = "100%", height = "100%"></center>
...
1. Males are disproportionately affected by color-blindess, an effect not accounted for in this analysis.  
