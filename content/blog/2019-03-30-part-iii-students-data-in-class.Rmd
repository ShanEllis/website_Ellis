...
| **Descriptive Analysis** | Y   | used student resposnes from survey to demonstrate examples of various common distributions, presented descriptive statistics from class data, & discussed "unanticipated" responses and need to look at your data|
