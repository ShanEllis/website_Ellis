...
I've written previously about teaching [COGS 18](https://cogs18.github.io/intro.html), an introductory programming course at UC San Diego [here](http://www.shanellis.com/blog/achieving-course-objectives-in-an-intro-programming-course/) and [here](http://www.shanellis.com/blog/improvement-in-teaching-intro-programming/). After the success I had [noted in 2020](http://www.shanellis.com/blog/achieving-course-objectives-in-an-intro-programming-course/) with more students reporting they had achieved the more vexxing course objectives (debugging, command line, best practices), I wanted to see where things stood after teaching this course all three quarters this past 2020-2021 academic year.
...
scale_x_discrete(expand=expansion(mult = c(0, 0.12),
  ...
  labs(y = "% of Responses",
       x = "quarter",
       title = "Trends in Course Objective achievment over time") +
  theme(title = element_text(size=10),
        axis.title = element_text(size=12),
        plot.title.position = "plot")
```
...
In coming quarters, staff and I have discussed moving it even earlier and giving more practice will help students with their debugging skils further. 
